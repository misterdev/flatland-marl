...
from torch_training.model import ConvQNetwork
...
class Agent:
    ...
    def __init__(self, action_size, env_width, env_height, double_dqn=True):
        ...
        # Q-Network
        self.qnetwork_local = ConvQNetwork(action_size, env_width, env_height).to(device) # in ddqn there are local and target networks
